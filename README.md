...
![Build](https://github.com/MukBet/intellij-plugin-test/workflows/Build/badge.svg)
...
- Manually:
  ...
  Download the [latest release](https://github.com/MukBet/intellij-plugin-test/releases/latest) and install it manually using
